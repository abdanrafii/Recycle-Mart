...
Route::middleware(['auth'])->group(function() {
    ...
    Route::get('orders/checkout/address', [OrderController::class, 'address'])->name('orders.address');
    Route::post('orders/checkout/address', [OrderController::class, 'add_address'])->name('orders.address');
